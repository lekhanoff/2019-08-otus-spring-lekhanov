...
public class GenreServiceImpl implements GenreService {
    ...
    public Genre updateGenre() {
        String genreId = reader.readLine(messageSource.getMessage("genre.update-get-id", null, Locale.getDefault()));
        ...
        return genreDao.save(Genre.builder().id(genreId).name(genreName).build());
    }

    @Override
    public void deleteGenre() {
        String genreId = reader.readLine(messageSource.getMessage("genre.delete", null, Locale.getDefault()));
    ...
    @Override
    public boolean checkGenreExists(String genreId) {

...
public class GenreServiceTest {
    ...
    private Genre fantasy = Genre.builder().id("1002").name("Fantasy").build();
    ...
    void testUpdateGenre() {
        ...
        Mockito.when(genreRepo.save(Genre.builder().id(genreId).name(genreName).build())).thenReturn(fantasy);
    ...
    void testGetById() {
        ...
        Mockito.when(genreRepo.findById("1000")).thenReturn(Optional.of(russianClassic));

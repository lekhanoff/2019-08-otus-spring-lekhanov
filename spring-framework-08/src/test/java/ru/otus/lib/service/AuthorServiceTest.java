...
public class AuthorServiceTest {
    ...
    private Author ivanov = Author.builder().id("1000").lastname("Ivanov").firstname("Ivan").middlename("Ivanovich").build();
    private Author petrov = Author.builder().id("1001").lastname("Petrov").firstname("Petr").middlename("Petrovich").build();
    ...
    void testCreateAuthor() {
        ...
        Mockito.when(authorRepo
                .save(Author.builder().lastname(lastname).firstname(firstname).middlename(middlename).build()))
                .thenReturn(ivanov);
    ...
    void testUpdateAuthor() {
        ...
        Mockito.when(authorRepo
                ...
                .thenReturn(true);
        Mockito.when(authorRepo
                .save(Author.builder().id(id).lastname(lastname).firstname(firstname).middlename(middlename).build()))
                .thenReturn(ivanov);
    ...
    void testGetById() {
        ...
        Mockito.when(authorRepo.findById("1000")).thenReturn(Optional.ofNullable(ivanov));
    ...
    @Test
    void testGetAll() {
        Mockito.when(authorRepo.findAll()).thenReturn(Arrays.asList(ivanov, petrov));

...
public class AuthorServiceImpl implements AuthorService {
    ...
    public AuthorServiceImpl(AuthorDao authorDao, @Lazy BookService bookService, MessageSource messageSource, @Lazy LineReader reader) {
    ...
    public Author updateAuthor() {
        ...
        return authorDao.updateAuthor(authorId, Author.builder().lastname(lastname).firstname(firstname).middlename(middlename).build());
    }

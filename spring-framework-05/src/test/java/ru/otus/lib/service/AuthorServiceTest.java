...
public class AuthorServiceTest {
    ...
    public void init() throws IOException {
        authorService = new AuthorServiceImpl(authorDao, bookService, messageSource, lineReader);
    }
    ...
    void testCreateAuthor() {
        ...
        assertEquals(1, Mockito.mockingDetails(authorDao).getInvocations().size());
    }
    ...
    void testUpdateAuthor() {
        ...
        Mockito.when(authorDao
                .updateAuthor(Long.valueOf(id), Author.builder().lastname(lastname).firstname(firstname).middlename(middlename).build()))
                .thenReturn(ivanov);
        ...
        assertEquals(2, Mockito.mockingDetails(authorDao).getInvocations().size());
    }
    ...
    void testGetById() {
        ...
        Mockito.when(authorDao.getById(1000L)).thenReturn(Optional.ofNullable(ivanov));
    ...
    @Test
    void testGetAll() {
        Mockito.when(authorDao.getAll()).thenReturn(Arrays.asList(ivanov, petrov));

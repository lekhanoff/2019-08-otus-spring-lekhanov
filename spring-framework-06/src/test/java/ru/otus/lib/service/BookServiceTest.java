...
public class BookServiceTest {
    ...
    void testCreateBook() {
        ...
        Mockito.when(bookDao
                .createBook(Book.builder().author(authorLeoTolstoy).genre(russianClassic).title(title).build()))
                .thenReturn(warAndPeace);
        Mockito.when(authorService.getById(Long.valueOf(authorId))).thenReturn(Optional.of(authorLeoTolstoy));
        Mockito.when(genreService.getById(Long.valueOf(genreId))).thenReturn(Optional.of(russianClassic));
    ...
    void testUpdateBook() {
        ...
        Mockito.when(bookDao
                ...
                .thenReturn(Optional.of(warAndPeace));
        Mockito.when(bookDao
                .updateBook(Book.builder().bookId(Long.valueOf(bookId)).author(authorLeoTolstoy).genre(russianClassic).title(title).build()))
                .thenReturn(warAndPeace);
        Mockito.when(authorService.getById(Long.valueOf(authorId))).thenReturn(Optional.of(authorLeoTolstoy));
        Mockito.when(genreService.getById(Long.valueOf(genreId))).thenReturn(Optional.of(russianClassic));
    ...
    void testGetById() {
        ...
        Mockito.when(bookDao.getById(1000L)).thenReturn(Optional.ofNullable(warAndPeace));
    ...
    @Test
    void testGetAll() {
        Mockito.when(bookDao.getAll()).thenReturn(Arrays.asList(warAndPeace, annaKarenina));
    ...
    void testGetBooksByAuthorId() {
        ...
        Mockito.when(bookDao.getBooksByAuthorId(Long.valueOf(authorId))).thenReturn(Arrays.asList(warAndPeace, annaKarenina));
    ...
    void testGetBooksByGenreId() {
        ...
        Mockito.when(bookDao.getBooksByGenreId(Long.valueOf(genreId))).thenReturn(Arrays.asList(warAndPeace, annaKarenina));

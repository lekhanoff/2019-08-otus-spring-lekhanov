...
public class GenreServiceTest {
    ...
    void testCreateGenre() {
        ...
        Mockito.when(genreRepo.createGenre(Genre.builder().name(genreName).build())).thenReturn(russianClassic);
    ...
    void testUpdateGenre() {
        ...
        Mockito.when(genreRepo.getById(genreId)).thenReturn(Optional.of(fantasy));
        Mockito.when(genreRepo.updateGenre(Genre.builder().genreId(genreId).name(genreName).build())).thenReturn(fantasy);
    ...
    void testGetById() {
        ...
        Mockito.when(genreRepo.getById(1000L)).thenReturn(Optional.of(russianClassic));
    ...
    void testGetByName() {
        ...
        Mockito.when(genreRepo.getByName("Russian Classic")).thenReturn(Optional.of(russianClassic));
    ...
    @Test
    void testGetAll() {
        Mockito.when(genreRepo.getAll()).thenReturn(Arrays.asList(russianClassic, foreignClassic));

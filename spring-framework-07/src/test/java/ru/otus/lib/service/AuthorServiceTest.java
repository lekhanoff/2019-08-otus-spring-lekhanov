...
public class AuthorServiceTest {
    ...
    void testUpdateAuthor() {
        ...
        Mockito.when(authorRepo
                .existsById(Long.valueOf(id)))
                .thenReturn(true);
        Mockito.when(authorRepo
                .save(Author.builder().authorId(Long.valueOf(id)).lastname(lastname).firstname(firstname).middlename(middlename).build()))
                .thenReturn(ivanov);
    ...
    void testGetById() {
        ...
        Mockito.when(authorRepo.findById(1000L)).thenReturn(Optional.ofNullable(ivanov));

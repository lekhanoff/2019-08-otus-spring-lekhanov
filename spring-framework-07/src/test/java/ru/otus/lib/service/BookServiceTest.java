...
public class BookServiceTest {
    ...
    void testUpdateBook() {
        ...
        Mockito.when(bookDao
                .existsById(Long.valueOf(bookId)))
                .thenReturn(true);
        Mockito.when(bookDao
                .save(Book.builder().bookId(Long.valueOf(bookId)).author(authorLeoTolstoy).genre(russianClassic).title(title).build()))
                .thenReturn(warAndPeace);
        Mockito.when(authorService.getById(Long.valueOf(authorId))).thenReturn(Optional.of(authorLeoTolstoy));
        Mockito.when(genreService.getById(Long.valueOf(genreId))).thenReturn(Optional.of(russianClassic));
    ...
    void testGetById() {
        ...
        Mockito.when(bookDao.findById(1000L)).thenReturn(Optional.ofNullable(warAndPeace));
    ...
    void testGetBooksByAuthorId() {
        ...
        Mockito.when(bookDao.findByAuthorAuthorId(Long.valueOf(authorId))).thenReturn(Arrays.asList(warAndPeace, annaKarenina));
    ...
    void testGetBooksByGenreId() {
        ...
        Mockito.when(bookDao.findByGenreGenreId(Long.valueOf(genreId))).thenReturn(Arrays.asList(warAndPeace, annaKarenina));

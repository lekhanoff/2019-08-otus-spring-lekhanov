...
public class AuthorServiceImpl implements AuthorService {
    ...
    public Author updateAuthor() {
        ...
        return authorDao.save(Author.builder().authorId(authorId).lastname(lastname).firstname(firstname).middlename(middlename).build());
    }
    ...
    public Optional<Author> getById() {
        ...
        return authorDao.findById(Long.valueOf(authorId));
    }
